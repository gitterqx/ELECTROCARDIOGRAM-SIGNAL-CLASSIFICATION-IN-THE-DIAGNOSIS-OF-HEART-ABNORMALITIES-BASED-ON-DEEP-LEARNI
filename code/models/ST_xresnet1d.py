...
from models.basic_conv1d import create_head1d, Flatten, create_priMask_ST
...
class XResNet1dST(nn.Sequential):
    @delegates(ResBlock)
...
def _xresnet1d_ST(expansion, layers, **kwargs):
    return XResNet1dST(ResBlock, expansion, layers, **kwargs)
    
def xresnet1d101_ST(**kwargs): return _xresnet1d_ST(4, [3, 4, 23, 3], **kwargs)
