...
from models.basic_conv1d import AdaptiveConcatPool1d,create_head1d,create_priMask_ST,priMaskST
...
class Inception1d_ST(nn.Module):
...
def inception1d_ST(**kwargs):
    """Constructs an Inception model
    """
    return Inception1d_ST(**kwargs)
