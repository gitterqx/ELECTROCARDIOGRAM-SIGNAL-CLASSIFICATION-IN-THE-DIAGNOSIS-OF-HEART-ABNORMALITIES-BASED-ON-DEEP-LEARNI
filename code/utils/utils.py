...
def evaluate_experiment(y_true, y_pred, thresholds=None):
    ...
    if not thresholds is None:
        ...
        errorRate,challenge_scores = challenge_metrics(y_true, y_pred_binary, beta1=2, beta2=2)
...
def challenge_metrics(y_true, y_pred, beta1=2, beta2=2, class_weights=None, single=False):
    ...
    for classi in range(y_true.shape[1]):
        ...
        errorRate = {'TP',TP,'FP',FP,'TN',TN,'FN',FN}
        f_beta += f_beta_i
        g_beta += g_beta_i

    return errorRate,{'F_beta_macro':f_beta/y_true.shape[1], 'G_beta_macro':g_beta/y_true.shape[1]}
...
def generate_ptbxl_summary_table_pri(selection=None, folder='../output/', models=None):

    exps = ['exp0', 'exp1', 'exp1.1', 'exp1.1.1']
    metric1 = 'macro_auc'
